...
private func XCTAssertMatches(_ regularExpression: Regex, _ stringMatch: String, _ file: StaticString = #file, line: UInt = #line) {
  XCTAssertTrue(regularExpression.matches(stringMatch), "expected <\(regularExpression)> to match <\(stringMatch)>", file: file, line: line)
}

private func XCTAssertDoesNotMatch(_ regularExpression: Regex, _ stringMatch: String, _ file: StaticString = #file, line: UInt = #line) {
...
private func XCTAssertCaptures(_ regularExpression: Regex, captures: String..., from string: String, _ file: StaticString = #file, line: UInt = #line) {
...
private func XCTAssertDoesNotCapture(_ regularExpression: Regex, captures: String..., from string: String, _ file: StaticString = #file, line: UInt = #line) {
  for expected in captures {
    let match = regularExpression.firstMatch(in: string)
    XCTAssertNotNil(match, file: file, line: line)
